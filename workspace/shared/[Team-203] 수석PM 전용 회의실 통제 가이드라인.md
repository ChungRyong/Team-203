...
2. 로컬 Ollama API를 열어 **`qwen3.6:35b-mlx`**에 **기획자 프롬프트**를 적용하고 대화 맥락을 넘겨 기획 명세서 작성을 지시합니다.
...
2. 로컬 Ollama API의 동일한 **`qwen3.6:35b-mlx`** 모델에 이번에는 **개발자 프롬프트**를 적용해 코딩을 지시합니다. (동일 모델 공유로 로딩 시간 0초)
